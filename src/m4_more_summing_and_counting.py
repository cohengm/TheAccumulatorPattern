...
Authors: David Mutchler, Dave Fisher, Valerie Galluzzi, Amanda Stouder,
         their colleagues and Geoffrey oCohen.
...
def run_test_count_cosines_from():
    ...
    expected = 14
    answer = count_cosines_from(3, 50, 0.6)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    expected = 10
    answer = count_cosines_from(6, 30, 0.2)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    expected = 4
    answer = count_cosines_from(0, 9, 0.3)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    expected = 4
    answer = count_cosines_from(0, 10, 0.4)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    expected = 3
    answer = count_cosines_from(3, 12, 0.5)
...
def run_test_sum_unit_fractions_from():
    ...
    expected = 1.4289682  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(3, 10)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    expected = 1.7178  # This is APPROXIMATELY the correct answer.
